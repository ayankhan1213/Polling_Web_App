...
const Signup = () => {
  ...
  return (
    <div className="relative flex h-screen items-center justify-center overflow-hidden bg-[#FEF9EF] px-4 py-4 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-md animate-[fadeIn_0.5s_ease] space-y-4  rounded-[24px] border-2 border-[#3FA35E]/20 bg-white p-6 shadow-[0_24px_60px_-10px_rgba(31,109,59,0.25)] max-h-full">
        {/* sprout mascot */}
